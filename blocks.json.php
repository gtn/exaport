...
if ($USER->picture) {
	...
	$content .= '<table style="width: 100%;">';
	$content .= '<tr><th>';
	$content .= '<label for="block_title">'.get_string('blocktitle','block_exaport').'</label>';
	$content .= '</th></tr>';
	$content .= '<tr><td>';
