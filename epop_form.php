...
<input type="submit" value="zu oezeps verbinden">
 	...
 	<h3>login</h3>
 	<form action="epop.php" method="post" >
...
<form action="epop.php" method="post" enctype="multipart/form-data">
 		<br><span class="title">key:</span> <input type="text" name="key" value="">
 		<br><span class="title">action:</span> <input type="text" name="action" value="get_courseid">
 		<br><input type="submit" value="get_courseid" class="submitbtn">
</form>
 </body>
</html>