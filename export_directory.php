...
if ($confirm) {
	...
	if ($owncats) {
		rekcat($owncats, $parsedDoc, $resources, $exportdir, $identifier, $ridentifier, $viewid, $organization, $i, $itemscomp, $categoriesSubdirName);
	};
...
echo '<input type="submit" name="export" value="' . get_string("createexport_directory", "block_exaport") . '" />';
