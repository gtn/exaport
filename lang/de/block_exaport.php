...
$string['settings_exaport_wp_sso_url'] = 'URL zum WordPress-SSO-Empfänger';
$string['settings_exaport_wp_sso_url_body'] = 'Die URL zum Server, der bereit ist, Befehle von Exaport zu empfangen';
$string['settings_exaport_wp_sso_passphrase'] = 'WordPress SSO-Passphrase';
$string['settings_exaport_wp_sso_passphrase_body'] = 'Die Passphrase zur Verbindung mit dem WordPress-SSO-Empfänger';
$string['settings_exaport_wp_sso_enabled'] = 'WordPress SSO-Verbindung aktivieren';
$string['settings_exaport_wp_sso_enabled_body'] = 'WordPress-Verbindung aktivieren. Die Optionen unten müssen konfiguriert werden';
$string['settings_exaport_wp_sso_error_no_url_configured'] = 'Richte zuerst die Option "block_exaport/wp_sso_url" ein';
$string['settings_exaport_reload_settings_page'] = 'Neu laden';
$string['settings_exaport_wp_sso_error_no_passphrase_registered'] = 'Die Passphrase muss auf dem WordPress-SSO-Server registriert sein.';
$string['settings_exaport_wp_sso_how_to_get_secret'] = 'Registriere deinen Wert "block_exaport/mysource" auf dem WordPress-SSO-Server und erhalte einen Geheimcode<br />Gib dann den Geheimcode unten ein, um die Passphrase zu erhalten';
$string['settings_exaport_wp_sso_url_to_get_secret'] = 'Geheimcode abrufen';
$string['settings_exaport_wp_sso_enter_secret_placeholder'] = 'Geheimcode eingeben';
$string['settings_exaport_wp_sso_request_passphrase_button'] = 'Passphrase anfordern';
$string['settings_exaport_wp_sso_passphrase_ok'] = 'Die Passphrase ist konfiguriert';
$string['settings_exaport_wp_sso_test_passphrase_button'] = 'Test';
$string['settings_exaport_wp_sso_remove_passphrase_button'] = 'Passphrase entfernen';
...
$string['wp_enter_secret'] = 'Gib das Geheimnis ein!';
$string['wp_something_went_wrong'] = 'Etwas ist schiefgelaufen!';
$string['wp_logged_in'] = 'Angemeldet';
$string['wp_updated'] = 'Aktualisiert';
$string['wp_exported'] = 'Exportiert';
$string['wp_removed'] = 'Entfernt';
$string['wp_request_error'] = 'Anfragefehler!';
$string['wp_request_error_code'] = 'Anfragefehler (Code: {$a})!';

// WordPress Integration - PHP messages
$string['wp_integration_title'] = 'WordPress-Integration';
$string['wp_logged_in_as'] = 'Du bist in WordPress angemeldet als Benutzer';
$string['wp_view_profile_page'] = 'Meine WordPress-Profilseite anzeigen';
$string['wp_update_profile_data'] = 'Meine WordPress-Profildaten aktualisieren';
$string['wp_curriculum_vitae'] = 'Lebenslauf';
$string['wp_cv_exported_at'] = 'Dein Lebenslauf wurde bereits nach WordPress exportiert am';
$string['wp_view'] = 'Anzeigen';
$string['wp_update_cv_data'] = 'Lebenslauf-Daten in WordPress aktualisieren';
$string['wp_remove'] = 'Entfernen';
$string['wp_import_cv'] = 'Lebenslauf nach WordPress importieren';
$string['wp_no_user_instance'] = 'Du hast keinen Benutzer in der verbundenen WordPress-Instanz';
$string['wp_register_user'] = 'Benutzer registrieren';
$string['wp_my_views'] = 'Meine Views';
$string['wp_exported_into'] = 'Nach WordPress exportiert';
$string['wp_updated_on'] = 'WordPress aktualisiert am';
$string['wp_view_in_wordpress'] = 'In WordPress anzeigen';
$string['wp_export_to_wordpress'] = 'Nach WordPress exportieren';
$string['wp_update_in_wordpress'] = 'In WordPress aktualisieren';
$string['wp_remove_from_wordpress'] = 'Aus WordPress entfernen';
