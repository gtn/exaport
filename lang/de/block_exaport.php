...
$string['wp_no_user_regitered'] = 'Es gibt noch keinen registrierten User in der zugeordneten Wordpress-Installation';
$string['wp_register_user'] = 'Bitte registrieren Sie den User hier';
$string['wp_view_my_profile_page'] = 'Meine Profilseite auf Wordpress ansehen';
$string['wp_update_my_profile_data'] = 'Aktualisiere meine Profilseite auf Wordpress';
$string['wp_import_my_cv'] = 'Importiere Lebenslauf in Wordpress';
$string['wp_view_in'] = 'In Wordpress anzeigen';
$string['wp_update_in'] = 'In Wordpress aktualisieren';
$string['wp_remove_from'] = 'von Wordpress entfernen';
$string['wp_my_views'] = 'Meine Portfolios';
$string['wp_export_to'] = 'Exportieren nach WordPress';
$string['wp_exported_into'] = 'Status in Wordpress';
$string['wp_updated_on'] = 'nach Wordpress exportiert';
