...
$string['myportfoliotitle'] = 'Exabis ePortfolio module: Εδώ μπορείτε να προσθέσετε τους συνδέσμους και τα αρχεία σας';
...
$string['importexport'] = 'Εξαγωγή/Εισαγωγή';
...
$string['exportcomment'] = 'Αυτό είναι ένα αρχείο που έχει εξαχθεί από το Exabis ePortfolio. Παρακαλώ μην αφαιρείτε τα σχόλια καθώς χρειάζονται για την εισαγωγή!';
...
$string['publishedportfolios'] = 'Δημοσιευμένες συλλογές';
...
$string['noviews'] = null;
$string['viewnotfound'] = 'Η συλλογή δεν βρέθηκε';
$string['newview'] = null;
