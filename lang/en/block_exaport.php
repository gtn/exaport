...
$string['exaport:shareintern'] = 'Internal sharing of collections';
$string['exaport:shareextern'] = 'External sharing of collections';
$string['exaport:allowposts'] = 'Allow posting';
$string['exaport:competences'] = 'Allow competences';
$string['exaport:viewartifactsfromstudents'] = 'Can see portfolio pages of own students';
$string['new'] = 'New';
...
$string['invalidparentcategory'] = 'Please select a valid parent category.';
$string['date'] = 'Date';
...
$string['shared_views'] = 'Shared Collections';
...
$string['emailaccessdescription'] = 'Input an email address per line<br />Each email will receive a unique link with access to this collection. Deleting the email will remove access to this collection.';
$string['emailaccessmessagesubject'] = 'New shared collection for you';
$string['emailaccessmessage'] = 'Hello! {$a->sendername} has shared the collection "{$a->viewname}" for you. You can view it here: {$a->url}';
$string['emailaccessmessageHTML'] = 'Hello!<br />{$a->sendername} has shared the collection "{$a->viewname}" for you.<br />You can view it <a href="{$a->url}">here</a>.';
...
// ],
$string['emailaccessmessagesubject_updatedview'] = '{$a->sendername} made changes to a collection shared with you.';
$string['emailaccessmessage_updatedview'] = 'Hello! {$a->sendername} has updated the collection "{$a->viewname}" they shared with you. You can view it here: {$a->url}';
$string['emailaccessmessageHTML_updatedview'] = 'Hello!<br />{$a->sendername} has updated the collection "{$a->viewname}" they shared with you.<br />You can view it <a href="{$a->url}">here</a>.';
...
$string['itemblock_editor_intro'] = 'Save the page details, then add, edit, remove, and reorder its content blocks below.';
$string['itemblock_empty'] = 'No content blocks have been added yet.';
$string['itemblock_movedown'] = 'Move down';
$string['itemblock_moveup'] = 'Move up';
$string['itemblock_reorderlabel'] = 'Drag to reorder this content block';
$string['itemblock_savefirst'] = 'Save the page first before adding content blocks.';
$string['invalidblockcontent'] = 'You must enter content or upload a file for this block.';
$string['invalidblockid'] = 'Invalid content block.';
$string['invalidblockorder'] = 'Invalid block order.';
$string['invalidblocktype'] = 'Invalid content block type.';
$string['invalidblockurl'] = 'You must enter a valid http or https URL.';
$string['intronotempty'] = 'You have to enter a content.';
$string['link'] = 'Link';
$string['mixed'] = 'Pages';
$string['add_mixed'] = 'Add new page';
...
$string['publishedportfolios'] = 'Published Collections';
...
$string['nothingsharedwithme'] = 'Nothing is shared with you';
$string['nothingsharedbyme'] = 'You haven\'t shared anything';
...
$string['exportviewselect'] = 'To export all items of a specific collection, please select it here';
...
$string['views'] = 'My Collections';
$string['explainingviews'] = 'Manage your collections.';
$string['noviews'] = 'Please create a new Collection';
$string['viewnotfound'] = 'Collection not found';
$string['newview'] = 'Add Collection';
$string['viewinformation'] = 'Collection Information';
$string['viewdescription'] = 'description';
$string['viewdesign'] = 'Collection Design';
$string['viewitems'] = 'Your Pages';
$string['viewitem'] = 'Page';
$string['view_specialitems'] = 'Special Pages';
...
$string['autofillview'] = 'Automatically add all available pages to this collection';
$string['sharetoteacher'] = 'Share to all teachers in this course';
$string['createpage'] = 'Drag and drop content blocks from the tabs below to create your collection.';
...
$string['item'] = 'Page';
$string['items'] = 'My Pages';
$string['items_help'] = 'The block with your pages<br><a href=\'{$a}\' target=\'_blank\' class=\'external-link\'>View your pages</a>';
$string['media'] = 'Media';
...
$string['listofartefacts'] = 'List of Pages';
$string['listofbadges'] = 'List of Badges';
$string['addButton'] = 'Add';
$string['saveButton'] = 'Save';
$string['saveViewShareSettingsButton'] = 'Share collection';
$string['saveViewButton'] = 'Save collection';
$string['saveAndNotifyButton'] = 'Save collection and send notifications';
...
$string['tagarea_block_exaportitem'] = 'My Pages';
...
$string['layout_mode_folder'] = 'Hierarchical';
$string['layout_mode_flat'] = 'Flat';
$string['searchcategory'] = 'Search Category...';
$string['add_view_entry'] = 'Collection';
$string['filter_entry_type'] = 'Show';
$string['filter_entry_type_all'] = 'All (pages &amp; collections)';
$string['filter_entry_type_items'] = 'Pages only';
$string['filter_entry_type_views'] = 'Collections only';
...
$string['configureblock_item'] = 'Choose pages';
...
$string['studentcomps'] = 'Here you can self-assess whether you have acquired the competency with your page.';
$string['teachercomps'] = 'Here you can assess whether your students have acquired the competency with this page.';
...
$string['settings_disable_externaccess_head'] = 'Disable Sharing-Option "External Access" for collections';
$string['settings_disable_externaccess_body'] = '';
$string['settings_disable_shareemails_head'] = 'Disable Sharing-Option "Share by Email" for collections';
$string['settings_disable_shareemails_body'] = '';
$string['settings_disable_external_comments_head'] = 'Disable sharing of comments in external collections';
...
$string['block_exaport_multiplefilesinitem'] = 'Multiple files in "File" page';
...
$string['block_exaport_copytomyportfolio_body'] = 'User will be able to copy pages from a shared category into their own collection';
...
$string['block_exaport_teachercanseeartifactsofstudents_head'] = 'Teacher can see ALL pages of own students';
$string['block_exaport_teachercanseeartifactsofstudents_head_alternative'] = 'Teacher can see ALL pages of own students';
...
$string['sharedArtefacts'] = 'Pages shared with you via categories';
$string['shareditems_category'] = 'Group portfolios shared with you';
$string['create_as_note'] = 'Create as Page';
...
$string['messageprovider:viewupdated'] = 'Updated collection notifications';
...
// ],
$string['i_shared'] = '{$a->sendername} shared the collection {$a->title} with you';
$string['i_updated'] = '{$a->sendername} made changes to the collection {$a->title} shared with you.';
$string['i_updated_category'] = '{$a->sendername} made changes to the shared category "{$a->title}"';
...
$string['pdf_settings_showmetadata'] = 'Add collection meta data';
...
$string['block_exaport_allowcustomlayout_head'] = 'Custom options for the collection layout for collection owners';
$string['block_exaport_allowcustomlayout_body'] = 'Allows to use custom collection layout settings (similar to options below) for regular owners of the collection';
$string['settings_layout_settings_description'] = 'Here you can change some collection layout options or use own custom CSS rules to have the collection as you want<br>These settings will be used as default settings <strong>for all collections</strong>';
$string['layout_settings'] = 'Layout settings';
$string['layout_settings_description'] = 'Here you can change some collection layout options or use own custom CSS rules to have the collection as you want';
...
$string['layout_settings_view_headers'] = 'Headers of collection blocks';
$string['layout_settings_view_content'] = 'Content of collection blocks';
...
$string['view_saved'] = 'Collection saved';
$string['view_sharing_updated'] = 'Collection sharing updated';
$string['list'] = 'List';
...
$string['privacy:metadata:block_exaportitem'] = 'user\'s page';
$string['privacy:metadata:block_exaportitemblock'] = 'structured content blocks for pages';
$string['privacy:metadata:block_exaportitemblock:itemid'] = 'id of the parent page';
$string['privacy:metadata:block_exaportitemblock:type'] = 'type of content block';
$string['privacy:metadata:block_exaportitemblock:sortorder'] = 'saved sort order';
$string['privacy:metadata:block_exaportitemblock:title'] = 'optional block title';
$string['privacy:metadata:block_exaportitemblock:content'] = 'rich text content';
$string['privacy:metadata:block_exaportitemblock:contentformat'] = 'text format';
$string['privacy:metadata:block_exaportitemblock:url'] = 'link url';
$string['privacy:metadata:block_exaportitemblock:timecreated'] = 'created time';
$string['privacy:metadata:block_exaportitemblock:timemodified'] = 'last modified time';
$string['privacy:metadata:block_exaportitem:userid'] = 'page\'s owner';
$string['privacy:metadata:block_exaportitem:type'] = 'type of page';
...
$string['privacy:metadata:block_exaportitem:example_url'] = 'Example url';
$string['privacy:metadata:block_exaportitem:parentid'] = 'parent id';
$string['privacy:metadata:block_exaportitemcomm'] = 'comments for pages';
$string['privacy:metadata:block_exaportitemcomm:itemid'] = 'id of page';
...
$string['privacy:metadata:block_exaportview'] = 'comments for page';
$string['privacy:metadata:block_exaportview:userid'] = 'owner of collection';
...
$string['privacy:metadata:block_exaportview:layout'] = 'layout of the collection';
$string['privacy:metadata:block_exaportview:sharedemails'] = 'shared emails list';
$string['privacy:metadata:block_exaportview:autofill_artefacts'] = 'enabled autofill for page';
...
$string['privacy:metadata:core_files'] = 'Exabis ePortfolio stores files which have been uploaded by the user to form part of pages, resume entries and comments.';
...
$string['view_preview_help'] = 'Preview of your collection';
$string['block_exaport_used_layout'] = 'Used layout';
$string['block_exaport_used_layout_body'] = 'Change the layout if you have some appearance problems. Right now it is used only for pages list.';
...
$string['settings_enable_myportfolio_head'] = 'Show "My Pages" area';
$string['settings_enable_myportfolio_body'] = 'Show or hide the "My Pages" navigation area.';
$string['settings_enable_views_head'] = 'Show "My Collections" area';
$string['settings_enable_views_body'] = 'Show or hide the "My Collections" navigation area.';
$string['settings_enable_shared_views_head'] = 'Show "Shared Collections" area';
$string['settings_enable_shared_views_body'] = 'Show or hide the "Shared Collections" navigation area.';
...
$string['wp_exported_view'] = 'Exported collection';
$string['wp_exported_view_hidden_in_wp'] = 'Exported but hidden in your WordPress';
$string['wp_exported_view_newer_than_wp'] = 'WordPress collection version is older than Moodle version';
...
$string['settings_category_distribution_description'] = 'Configure starter templates for course-managed category and collection distribution';
...
$string['settings_starter_view_templates'] = 'Starter Collection Templates';
...
$string['category_distribution_description'] = 'Manage and distribute category and collection structures to students';
...
$string['confirm_distribute_views_body'] = 'Are you sure you want to distribute the collection templates to all enrolled students? This will create collections for students who do not already have them. This action cannot be undone. Once distributed, the collections are created.';
...
$string['view_distribution'] = 'Collection Distribution';
$string['view_distribution_description'] = 'Manage and distribute collection templates to students. Collections help students showcase their work.';
$string['starter_view_template_select'] = 'Select Starter Collection Template';
$string['current_view_template'] = 'Current Collection Template';
$string['view_template_empty'] = 'No collection in template. Add a collection to get started.';
$string['add_view'] = 'Add Collection';
$string['rename_view'] = 'Rename Collection';
$string['remove_view'] = 'Remove Collection';
$string['remove_view_confirm'] = 'Are you sure you want to remove this collection from the template? This will not delete existing student collections.';
$string['view_name_required'] = 'Collection name is required';
$string['view_added'] = 'Collection added to template';
$string['view_renamed'] = 'Collection renamed successfully';
$string['view_removed'] = 'Collection removed from template';
$string['distribute_views'] = 'Distribute Collections';
$string['distribute_views_now'] = 'Distribute Collections Now';
$string['auto_distribute_views_on_enrolment'] = 'Automatically distribute collections to new enrolments';
