...
$string['wp_no_user_regitered'] = 'You do not have a user in the associated Wordpress instance';
$string['wp_register_user'] = 'Register user';
$string['wp_view_my_profile_page'] = 'View my Wordpress Profile Page';
$string['wp_update_my_profile_data'] = 'Update my WordPress profile data';
$string['wp_import_my_cv'] = 'Import CV into WordPress';
$string['wp_view_in'] = 'View in WordPress';
$string['wp_update_in'] = 'Update in WordPress';
$string['wp_remove_from'] = 'Remove from WordPress';
$string['wp_my_views'] = 'My views';
$string['wp_export_to'] = 'Export to WordPress';
