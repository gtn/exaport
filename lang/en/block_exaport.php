...
$string['emailaccessmessage_updatedview'] = 'Hello! {$a->sendername} has updated the view "{$a->viewname}" he shared with you. You can view it here: {$a->url}';
$string['emailaccessmessageHTML_updatedview'] = 'Hello!<br />{$a->sendername} has updated the view "{$a->viewname}" he shared with you.<br />You can view it <a href="{$a->url}">here</a>.';
