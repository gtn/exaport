...
$string['settings_exaport_wp_sso_error_no_url_configured'] = 'First set up the "block_exaport_wp_sso_url" option';
...
$string['settings_exaport_wp_sso_how_to_get_secret'] = 'You need to register your "block_exaport_mysource" value into WordPress SSO server and get a secret code<br />Then you need to insert the secret code into field below and get the passphrase';
...
$string['wp_exported_view_hidden_in_wp'] = 'Exportiert, aber auf der Wordpress-Seite ausgeblendet';
