...
$string['settings_enable_my_shares_body'] = 'Show or hide the "My Shares" navigation area, an overview of items, categories and views the current user shares with others.';
$string['settings_enable_shared_with_me_head'] = 'Show "Shared with me" area';
$string['settings_enable_shared_with_me_body'] = 'Show or hide the "Shared with me" navigation area, an overview of items, categories and views other users have shared with the current user.';
...
$string['settings_starter_view_templates_description'] = 'JSON array of starter collection templates. Each template must have "name" and "views" (array of collection objects with name, description, and share_to_teachers).';
