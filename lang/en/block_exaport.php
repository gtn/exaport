...
$string['category_distribution_description'] = 'Manage category and view templates for automatic distribution to users in this course.';
$string['templates_for_course'] = 'Templates for this course';
$string['category_templates'] = 'Category Templates';
$string['view_templates'] = 'View Templates';
$string['no_templates_found'] = 'No templates found for this course. Templates can be created and will be automatically distributed when enabled.';
