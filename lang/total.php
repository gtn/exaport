...
',
        ...
        'block_exaport_app_teachercanseeartifactsofstudents_head' => [
                'Teacher can see ALL artifacts of own students',
                'Teacher can see ALL artifacts of own students',
        ],
        'block_exaport_app_teachercanseeartifactsofstudents_body' => [
                'You also need to configure trusted teachers in theirs profiles. Be accuracy with trusted users.<br />List of students for every teacher are generated by course enrollments. The student can not disable this access. But he can to rule the access to other users as usual',
                'You also need to configure trusted teachers in theirs profiles. Be accuracy with trusted users.<br />List of students for every teacher are generated by course enrollments. The student can not disable this access. But he can to rule the access to other users as usual',
        ],
